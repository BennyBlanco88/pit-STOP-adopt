...
export default function Home() {
    return (
        <Container>
              <img src='/assets/hero1.jpg' alt='Hero1' id='hero1' />
              ...
              <img src='/assets/hero2.jpg' alt='Hero2' id='hero2' />
            ...
            <img id='childpic'src='/assets/child.jpg' alt='dog and child' />
            </Container>
            ...
            <img src='/assets/aspca.jpg' alt='ASPCA' id='aspca' />
            <p id='consider'>
